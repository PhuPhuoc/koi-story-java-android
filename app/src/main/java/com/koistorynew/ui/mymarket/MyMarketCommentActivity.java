...
public class MyMarketCommentActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView() {
        ...
        commentAdapter = new com.koistorynew.ui.mymarket.adapter.CommentAdapter(commentList);
                ...
                response -> {
                    try {
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            PostMyMarketComment postMyMarketComment = new PostMyMarketComment(author,date, comment, avatarUrl);
                            commentList.add(postMyMarketComment);
                        }
